        ...
        loginForm.addEventListener('submit', function (event) {
            ...
            if (isFormValid) {
                ...
                if (storedUser && storedUser.password === password) {
                    ...
                    document.getElementById('loginErrorGeneral').textContent = 'Email hoặc mật khẩu không đúng hoặc chưa đăng ký.';
                }
            }
            ...
            if (isFormValid) {
                ...
                setTimeout(() => {
                    ...
                    if (storedUser) {
                        ...
                        const bsLoginTab = new bootstrap.Tab(document.getElementById('login-tab-modal'));
                        bsLoginTab.show();
                    }
                }, 500);
            }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (loggedInUser) {
        ...
        welcomeUser.textContent = 'Xin chào, ' + loggedInUser;
    } else {
